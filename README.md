...
1. Download **`VOIDTUNE-0.8.9-Setup.msi`** from the [Releases](https://github.com/otzpt/VOIDTUNE/releases) page.
...
1. Download **`VOIDTUNE-0.8.9-portable-win-x64.zip`** from [Releases](https://github.com/otzpt/VOIDTUNE/releases).
