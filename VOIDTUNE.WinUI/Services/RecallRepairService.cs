...
public static class RecallRepairService
{
    ...
    /// <summary>
    /// ix1/ix3 (removed 0.8.17) wrote ValueMax=0 / ValueMin=100 onto the machine-wide
    ...
    /// <summary>
    /// Pre-0.8.17 ux1 set HungAppTimeout=2000 + AutoEndTasks=1, which made Windows auto-kill
